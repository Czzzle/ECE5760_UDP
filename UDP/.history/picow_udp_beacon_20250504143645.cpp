...
static void raw_send(char send_data[], GAME_STATUS status, GRID_STATE state, Coordinate8 coord, int sendOption)
{
  ...
  switch(sendOption){
    case 1: 
      //send Game Status
      switch (status) {
        case GAME_STATUS::INITIAL: return "INITIAL";
        case GAME_STATUS::LEVEL:   return "LEVEL";
        case GAME_STATUS::PLACE:   return "PLACE";
        case GAME_STATUS::ONGOING: return "ONGOING";
        case GAME_STATUS::WIN:     return "WIN";
        case GAME_STATUS::LOSE:    return "LOSE";
