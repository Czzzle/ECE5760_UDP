...
PlayerState my_state = RA;
PlayerState opponent_state = YT;
...
static PT_THREAD(protothread_anim(struct pt *pt))
{
  ...
  while (1)
  {
    ...
    else if(opponent_player.game_status == GAME_STATUS::LOSE)
    {
    ...
    {
      raw_send(GAME_STATUS::WIN, GRID_STATE::HIT, {30,30}, 1);
      loserDeclare(WHITE);
    }
