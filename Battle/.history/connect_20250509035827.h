...
// Wifi information
#define WIFI_SSID "Dlr99_z6"
#define WIFI_PASSWORD "dikshu123456"
// #define WIFI_SSID "akansha"
// #define WIFI_PASSWORD "akansha29"
...
int connectWifi(uint32_t country, const char *ssid, const char *pass, uint32_t auth) {
    ...
    if (cyw43_arch_wifi_connect_timeout_ms(ssid, pass, auth, timeout_ms)) {
        return 2 ;
    }
