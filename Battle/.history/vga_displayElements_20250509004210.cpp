...
{
    static char shipslist[50];
    fillRect(pos_x - 1, pos_y - 3, 1, 13, color);
...
void drawBlackBoxforShip()
{
    ...
    fillRect(RIGHT_GRID_X - 1, SHIPLIST_SPACE_Battleship - 3, RIGHT_GRID_X - 3, 17, BLACK);
    fillRect(RIGHT_GRID_X - 1, SHIPLIST_SPACE_Cruiser - 3, RIGHT_GRID_X - 3, 17, BLACK);
    fillRect(RIGHT_GRID_X - 1, SHIPLIST_SPACE_Submarine - 3, RIGHT_GRID_X - 3, 17, BLACK);
    fillRect(RIGHT_GRID_X - 1, SHIPLIST_SPACE_Destroyer - 3, RIGHT_GRID_X - 3, 17, BLACK);
}
/*
